...
describe('AppComponent', () => {
    ...
    it('runImageClassifier should correctly parse image classifier model outputs with correct labelmap', async () => {
        const fixture = testing_1.TestBed.createComponent(app_component_1.AppComponent);
        const app = fixture.componentInstance;
        // Prepare test data.
    ...
    it('runImageClassifier should correctly parse image classifier model outputs with empty labelmap', async () => {
        const fixture = testing_1.TestBed.createComponent(app_component_1.AppComponent);
        const app = fixture.componentInstance;
        // Prepare test data.
        const fakeImage = new Image();
    ...
    it('runImageDetector should execute correctly', async () => {
        const fixture = testing_1.TestBed.createComponent(app_component_1.AppComponent);
        const app = fixture.componentInstance;
        // Prepare test data.
        const fakeImage = new Image();
    ...
    it('runImageSegmenter should execute correctly', async () => {
        const fixture = testing_1.TestBed.createComponent(app_component_1.AppComponent);
        const app = fixture.componentInstance;
        // Prepare test data.
        const fakeImage = new Image();
